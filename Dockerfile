...
RUN apt-get update && apt-get install --no-install-recommends -y \
        ca-certificates curl adduser bzip2 &&\
        curl https://download.foldingathome.org/releases/public/release/fahclient/debian-stable-64bit/v${FAH_VERSION_MAJOR}/fahclient_${FAH_VERSION_MINOR}_amd64.deb > /tmp/fah.deb &&\
